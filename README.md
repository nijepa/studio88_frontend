# Studio 88 pilates ## frontend (go to [backend](https://github.com/nijepa/studio88_backend/))

## Web-App for managing pilates club ### (Clients, training groups, attendances, payments, expenses ...)
