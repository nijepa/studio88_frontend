  ...
  <div v-else class="client__wrapper" key="2" id="tops">
    ...
    <div class="activities__wrapper">
      ...
      <div class="">
        <h3 class="activities__title">
          Prisustva - ukupno :
          <span class="activities__title_val"> {{ totalAttendances() }} </span>
          od
          <span class="activities__title_val">
            {{ clientAttendances.length }}</span
          >
        </h3>
        ...
        <jw-pagination
          :items="filteredClientsA"
          @changePage="onChangePageA"
          :initialPage="initialPage"
          :pageSize="pageSize"
          :labels="customLabels"
          :styles="customStyles"
