<template>
  <div class="lists__wrapper">
    <transition-group name="fall" mode="out-in">
      <form
        @submit.prevent="changeGeneral()"
        action=""
        key="1"
        v-on:load="onAppeared"
        v-show="appeared"
        class="user__form generals__form"
      >
        ...
        <div class="generals__container">
          <div class="input__field">
            ...
            <input
              @focus="clearErrors"
              v-model="generalInput.general_title"
          ...
          <div class="input__field">
            ...
            <input
              @focus="clearErrors"
              v-model="generalInput.general_address"
              class="login_input user_input"
              type="text"
              name="address"
              id="address"
          ...
          <div class="input__field">
            ...
            <input
              @focus="clearErrors"
              v-model="generalInput.general_site"
              class="login_input user_input"
              type="text"
              name="site"
              id="site"
          ...
          <div class="input__field">
            ...
            <input
              @focus="clearErrors"
              v-model="generalInput.general_email"
              class="login_input user_input"
              type="email"
              name="email"
              id="email"
          ...
          <div class="input__field">
            ...
            <input
              @focus="clearErrors"
              v-model="generalInput.general_mobile"
              class="login_input user_input"
              type="text"
              name="mobile"
              id="mobile"
          ...
          <div class="input__field">
            ...
            <input
              @focus="clearErrors"
              v-model="generalInput.general_instagram"
              class="login_input user_input"
              type="text"
              name="instagram"
              id="instagram"
          ...
          <div class="input__field">
            ...
            <input
              @focus="clearErrors"
              v-model="generalInput.general_facebook"
              class="login_input user_input"
              type="text"
              name="facebook"
              id="facebook"
          ...
          <div class="input__field">
            ...
            <datepicker
              v-model="generalInput.general_date"
        ...
        <div class="prices">
          ...
          <div class="action_btn save__btn price__btn" @click="addNewPrice()">
            <svg
              ...
              style="enable-background: new 0 0 497.4 497.4"
              xml:space="preserve"
            >
              <path
                style="fill: var(--purple)"
                d="M418.149,62.4l-168-9.6c-8-0.8-15.2,2.4-20.8,8L16.549,260c-10.4,10.4-16.8,35.2-6.4,46.4
              ...
              <path
                style="fill: var(--purple)"
                d="M418.149,48.8l-168-9.6c-8-0.8-15.2,2.4-20.8,8L16.549,260c-10.4,10.4-10.4,28,0,39.2l176.8,176.8
                c10.4,10.4,28,10.4,39.2,0l212.8-212.8c5.6-5.6,8.8-12.8,8-20.8l-9.6-167.2C442.949,60.8,431.749,49.6,418.149,48.8z"
              />
              <path
                style="fill: var(--purple)"
                d="M193.349,476c10.4,10.4,28,10.4,39.2,0l212.8-212.8c5.6-5.6,8.8-12.8,8-20.8l-9.6-167.2
                c-0.8-13.6-12-24.8-25.6-25.6l-168-10.4c-8-0.8-15.2,2.4-20.8,8"
              />
              <path
                style="fill: var(--purple)"
                d="M407.749,129.6c0,24.8-20,58.4-45.6,58.4c-24.8,0-45.6-33.6-45.6-58.4s20-45.6,45.6-45.6
              ...
              <path
                style="fill: var(--purple)"
                d="M330.949,97.6c17.6-17.6,46.4-17.6,64,0s17.6,46.4,0,64"
              />
              <circle style="fill: #ebf0f2" cx="362.949" cy="129.6" r="27.2" />
              <path
                style="fill: #cadfe5"
                d="M382.149,110.4c10.4,10.4,10.4,27.2,0,37.6s-27.2,10.4-37.6,0"
              />
              <g>
                <path
                  style="
                  ...
                  "
                  d="M490.149,12.8c3.2-3.2,3.2-7.2,0-10.4l0,0
                  c-3.2-3.2-7.2-3.2-10.4,0l-122.4,122.4c-3.2,3.2-3.2,7.2,0,10.4l0,0c3.2,3.2,12.8,8.8,16,5.6L490.149,12.8z"
                />
                <path
                  style="fill: var(--purple)"
                  d="M490.149,12.8c3.2-3.2,3.2-7.2,0-10.4l0,0c-3.2-3.2-7.2-3.2-10.4,0l-122.4,122.4
                  c-3.2,3.2-3.2,7.2,0,10.4l0,0c3.2,3.2,7.2,3.2,10.4,0L490.149,12.8z"
                />
              </g>
              <path
                style="fill: var(--purple)"
                d="M357.349,135.2L357.349,135.2c3.2,3.2,7.2,3.2,10.4,0l122.4-122.4c3.2-3.2,3.2-7.2,0-10.4l0,0"
              />
              <path
                style="fill: var(--purple-lighter)"
                d="M338.949,307.2c4.8,4.8,4.8,12,0,16.8l-117.6,117.6c-4.8,4.8-12,4.8-16.8,0L50.949,288
                c-4.8-4.8-4.8-12,0-16.8l117.6-117.6c4.8-4.8,12-4.8,16.8,0L338.949,307.2z"
              />
              <path
                style="fill: var(--purple-light)"
                d="M338.949,307.2l-121.6-120.8l-20.8,248l8,8c4.8,4.8,12,4.8,16.8,0l117.6-117.6
